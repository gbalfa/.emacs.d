...
* Autor
  ...
  Basada en configuración de Harry R. Schwartz
...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Gabriel Badilla Alfaro"
        user-mail-address "gabriel.badilla@usach.cl"
...
Configure ycmd with the associated ==company== mode:
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package ycmd
    ...
    ;;   (set-variable 'ycmd-server-command '("python" "-u" "/usr/share/ycmd/ycmd"))
    ;; ;;
    (set-variable 'ycmd-server-command '("python" "-u" "/usr/share/vim/vimfiles/third_party/ycmd/ycmd"))
    (set-variable 'ycm_use_clangd 1)
    (set-variable 'ycm_clangd_binary_path "/usr/bin/clangd")
...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "M-ñ") 'helm-show-kill-ring)
#+END_SRC
...
Documentation whith Sphinx and Python-docstring.
...
** Options
   ...
   Alphabetical ordered items

   #+BEGIN_SRC emacs-lisp
     (setq org-list-allow-alphabetical t)
   #+END_SRC

   Table captions below
...
** Plain text without line breaks
 #+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (setq ispell-program-name "hunspell -d")
...
#+BEGIN_SRC emacs-lisp
  (setq yas-snippet-dirs '("~/.emacs.d/snippets" "~/.emacs.d/elpa/yasnippet-snippets-20200526.907/snippets"))
  (yas-global-mode 1)
#+END_SRC
