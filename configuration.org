...
#+BEGIN_SRC emacs-lisp
  ...
  ;; ;;
    (set-variable 'ycmd-server-command '("python" "-u" "/home/gabriel/ycmd/ycmd"))
    (set-variable 'ycmd-global-config "/home/gabriel/.ycm_extra_conf.py")
    )
